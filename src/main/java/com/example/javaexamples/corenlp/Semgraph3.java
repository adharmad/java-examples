...
//        props.setProperty("ner.applyFineGrained", "false");
        ...
        String sentenceText = """
                What are the different file types in the application?
                Give a list of the different file types in the application.
                List the file types in the application.
                Get the file types in the application.
                Return the unique file types in the application.
                Tell me the file extensions in the application.
                """;
